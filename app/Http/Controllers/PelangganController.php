...
class PelangganController extends Controller {
 ...
 private function validated(Request $r,?Pelanggan $p=null): array { return $r->validate(['nama'=>['required','max:100'],'email'=>['required','email',Rule::unique('users')->ignore($p?->user_id)],'password'=>[$p?'nullable':'required','min:8'],'no_telepon'=>['required','max:20'],'alamat'=>['nullable','max:500']]); }
